...
public class BinaryTreeArrayMain27 {
    ...
    public static void main27(String[] args) {
        ...
        int idxLast = 6;
        bta.populateData27(dataMahasiswa, idxLast);

        System.out.println("\nInOrder Traversal Mahasiswa:");
        bta.traverseInOrder27(0);

        System.out.println("\nPreOrder Traversal Mahasiswa:");
        bta.traversePreOrder27(0);

        System.out.println("\nMenambahkan data baru ke array tree:");
        bta.add27(new Mahasiswa27("244160199", "Ghani", "C", 3.92));

        System.out.println("\nInOrder Traversal setelah tambah data:");
        bta.traverseInOrder27(0);
    }
}